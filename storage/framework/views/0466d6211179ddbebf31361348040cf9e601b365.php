    ...
    <div class="main_full">
        ...
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('video')); ?>" method="post" lay-filter="fb-form">
                    <div class="layui-form-item">
                        <label class="layui-form-label">* <?php echo e(trans('app.title')); ?></label>
                        <div class="layui-input-inline">
                            <input type="text" name="title" lay-verify="required" autocomplete="off" placeholder="请输入<?php echo e(trans('app.title')); ?>" class="layui-input" >
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">* <?php echo e(trans('video.label.vid')); ?></label>
                        <div class="layui-input-inline">
                            <input type="text" name="vid" lay-verify="required" autocomplete="off" placeholder="请输入<?php echo e(trans('video.label.vid')); ?>" class="layui-input" >
                        </div>
                    </div>
                    <div class="layui-form-item">
