            ...
            <div class="power-box  fb-clearfix">
                ...
                <div class="power-box-con">
                    <div class="power-box-item layui-col-md2">
                        <a href="<?php echo e(guard_url('order/create')); ?>">
                            <?php echo e(trans('app.add')); ?>订单
                        </a>
                    </div>
                    <div class="power-box-item layui-col-md2">
                        <a href="<?php echo e(guard_url('customer/create')); ?>">
                            <?php echo e(trans('app.add')); ?>客户
                        </a>
                    </div>
                    <div class="power-box-item layui-col-md2">
                        <a href="<?php echo e(guard_url('new_customer/create')); ?>">
                            <?php echo e(trans('app.add')); ?>收集客户
                        </a>
                    </div>
                    <div class="power-box-item layui-col-md2">
                        <a href="<?php echo e(guard_url('goods/create')); ?>">
                            <?php echo e(trans('app.add')); ?>产品
                        </a>
                    </div>
                    <div class="power-box-item layui-col-md2">
                        <a href="#">
