        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="<?php echo e(guard_url('page/joint_research_institute/create')); ?>"><?php echo e(trans('app.add')); ?></a></button>
...
<script>
    var main_url = "<?php echo e(guard_url('page/joint_research_institute')); ?>";
    var delete_all_url = "<?php echo e(guard_url('page/joint_research_institute/destroyAll')); ?>";
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'description',title:'<?php echo e(trans('page.label.description')); ?>',edit:'text' , width:280}
                ,{field:'image',title:'<?php echo e(trans('page.label.image')); ?>', toolbar:'#imageTEM', width:120}
        ...
        form.on('switch(home_recommend)', function(obj){
            ...
            var load = layer.load();
            $.post("<?php echo e(guard_url('joint_research_institutes/updateRecommend')); ?>",{"id":this.value,"home_recommend":value,'_token':"<?php echo csrf_token(); ?>" },function(){
                layer.close(load);
                if(data.code != 0)
                {
        ...
        form.on('switch(hot_recommend)', function(obj){
            var  value = obj.elem.checked ? 1 : 0;
            var load = layer.load();
            $.post("<?php echo e(guard_url('joint_research_institutes/updateRecommend')); ?>",{"id":this.value,"hot_recommend":value,'_token':"<?php echo csrf_token(); ?>" },function(){
                layer.close(load);
                if(data.code != 0)
                {
                    layer.msg(data.message);
