                ...
                <form class="layui-form" action="<?php echo e(guard_url('role/'.$role->id)); ?>" method="POST" lay-filter="fb-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="name" lay-verify="required" autocomplete="off" placeholder="请输入<?php echo trans('role.label.name'); ?>" class="layui-input" value="<?php echo e($role->name); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
