        ...
        <div class="article-detail clearfix  wow fadeInUp animated" data-wow-duration=".6s" data-wow-delay=".5s">
            <div class="news-detail-tab pull-left ">
                <ul>
                    ...
                    <li class="<?php if($page->id == $page_item->id): ?> active <?php endif; ?> transition500"><a href="<?php echo e(route('pc.culture.show',$page_item->id)); ?>"><?php echo e($page_item->title); ?></a></li>
