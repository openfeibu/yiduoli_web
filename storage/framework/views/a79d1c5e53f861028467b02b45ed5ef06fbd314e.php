...
<script>
    ...
    function postFeedback(){
        ...
        $.ajax({
            url : "<?php echo e(route('pc.feedback.store')); ?>",
            data : {'name':name,'phone':phone,'email':email,'content':content,'_token':"<?php echo csrf_token(); ?>"},
            type : 'post',
            dataType : "json",
            success : function (data) {
                if(data.code != 0)
                {
                    ...
                    alert("<?php echo e(trans('app.success.action')); ?>");
                }
            },
