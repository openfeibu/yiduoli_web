    ...
    <div class="main_full">
        ...
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('page/join_us/'.$page->id)); ?>" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="slug" lay-verify="required" autocomplete="off" placeholder="请输入<?php echo e(trans('page.label.slug')); ?>" class="layui-input" value="<?php echo e($page->slug); ?>" >
                        </div>
                    </div>
