        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="<?php echo e(guard_url('permission/create')); ?>"><?php echo e(trans('app.add')); ?></a></button>
    ...
    layui.use(['element','table'], function(){
        ...
        table.on('tool(fb-table)', function(obj){
            ...
            if(obj.event === 'detail'){
                ...
                layer.confirm('真的<?php echo e(trans('app.delete')); ?>行么', function(index){
                    layer.close(index);
                    var load = layer.load();
                    $.ajax({
