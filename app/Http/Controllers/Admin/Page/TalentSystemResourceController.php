 ...
 */
class TalentSystemResourceController extends BaseController
{
    /**
                                ...
                                PageCategoryRepositoryInterface $category)
    {
        ...
        $this->category_slug = 'talent_system';
        $this->main_url = 'page/talent_system';
    ...
    public function show(PageRequest $request,Page $talent_system)
    {
        return parent::show($request,$talent_system);
    }
    public function update(PageRequest $request,Page $talent_system)
    {
        return parent::update($request,$talent_system);
    }
    public function destroy(PageRequest $request,Page $talent_system)
    {
        return parent::destroy($request,$talent_system);
    }
