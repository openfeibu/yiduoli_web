...
class TalentSystemController extends BaseController
{
    ...
    )
    {
        ...
        $this->route_slug = $this->category_slug = 'talent_system';
    ...
    public function show(Request $request,Page $talent_system)
    {
