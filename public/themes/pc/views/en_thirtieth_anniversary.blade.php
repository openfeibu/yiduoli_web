	    ...
	    <div class="container w1200 live-con" style="max-width:1320px !important">	
			...
			<div class=" live-left col-xs-12 col-sm-12 wow fadeInUp animated" data-wow-duration=".6s" data-wow-delay=".3s"  >
				<div class="live-img-item " style="display:block;">
					<a target="_black" href="https://wx.vzan.com/live/tvchat-1500962325?v=1616488903094"><img class="transition" src="{!! theme_asset('images/30/en-liveimg1.jpg') !!}" alt="" /></a>
				</div>
				<div class="live-img-item">
					<a target="_black" href="https://wx.vzan.com/live/tvchat-764500050?v=1616488847371"><img class="transition" src="{!! theme_asset('images/30/en-liveimg2.jpg') !!}" alt="" /></a>
				</div>
				<!--<div class="live-img-item">
